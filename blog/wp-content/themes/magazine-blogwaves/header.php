...
<div id="page" class="site-wrapper site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'magazine-blogwaves' ); ?></a>
<?php 
...
?>
	<header  id="masthead" class="wp-main-header">
		...
		<!-- Start Navbar Area -->
<nav id="site-navigation" class="main-navigation menu-bg" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'magazine-blogwaves' ); ?>">
...
<div>
	...
	<div class="nav-line"></div>
		<div class="main-logo">
			<img src="https://humantroop.in/blog/wp-content/uploads/2023/05/logo-2.png" class="img-logo" />
	</div>
</nav>
</header>
