	...
	public static function bd_classical_template( $alterclass ) {
		...
		<div class="blog_template bdp_blog_template classical">
			...
			<div class="bd-post-content">
				<?php echo wp_kses( Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ), Blog_Designer_Lite_Template::args_kses() ); ?>
				<?php
	...
	public static function bd_spektrum_template() {
		...
		<?php if ( has_post_thumbnail() ) { ?>
			...
			<div class="spektrum_content_div">
				...
				<div class="bd-post-content">
					<?php
					echo wp_kses( Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ), Blog_Designer_Lite_Template::args_kses() );
				...
				if ( get_the_content() || has_post_thumbnail() ) {
					...
					<div class="post_summary_outer">
						...
						if ( get_the_content() ) {
							...
							<div class="post_content"> 
								<div class="post_content-inner">
									<p><?php echo wp_kses( Blog_Designer_Lite_Public::bd_get_content( get_the_ID() ), Blog_Designer_Lite_Template::args_kses() ); ?></p>
